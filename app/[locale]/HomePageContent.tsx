...
import { ClassesProgramSection } from "@/components/home/ClassesProgramSection";
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="container px-4 py-16 md:py-24">
        <h2 className="font-display mb-10 text-center text-2xl font-bold tracking-tight text-foreground md:text-3xl">
          {t("servicesTitle")}
        </h2>
        <motion.div
